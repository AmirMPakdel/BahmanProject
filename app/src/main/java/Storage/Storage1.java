...
public class Storage1 // QG Storage1 System
{
     ...
     *
     * @param ctx
     * @param storageName is a const string from MConstants.Storage1
     */
    public Storage1(Context ctx , String storageName)
    {
